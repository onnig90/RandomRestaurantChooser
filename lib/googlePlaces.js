...
async function applyRouteDistanceFilter(location, restaurants, maxDistanceMeters) {
  ...
  // For large candidate sets Haversine is already a good approximation;
  // avoid many Distance Matrix batches that would exceed the function timeout.
  if (restaurants.length > 50) return restaurants;
